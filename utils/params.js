...
const circuitInputPath = path.join(__dirname + circuitPath + `${circuitName}-input.json`);
const circuitBuildPath_build = path.join(__dirname + circuitBuildPath + 'build');
const circuitBuildPath_output = path.join(__dirname + circuitBuildPath + 'output');
const circuitBuildPath_solidity = path.join(__dirname + circuitBuildPath + 'solidity');
const circuitBuildPath_tau = path.join(__dirname + circuitBuildPath + 'tau');
